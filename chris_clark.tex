...
\begin{itemize}
  ...
  \item \textit{CXOzone}: Partnered with a small team of entrepreneurs to create a web application
    pairing high-level executives with new opportunities. See \texttt{cxo.zone}.
...
\vskip 5pt
  ...
  \begin{itemize}
    \item Designed, created, and maintain \texttt{lenaclarklegal.com}, a website for my wife's legal practice
      (deployed on AWS).
