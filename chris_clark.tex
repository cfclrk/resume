...
\begin{center}
  ...
  3330 Spring Ln \enspace\textopenbullet\enspace 
  Falls Church, VA 22041 \enspace\textopenbullet\enspace
...
% ------------------------ SECTION: RELEVENT SKILLS ----------------------------
  ...
  \begin{multicols}{2}
    ...
    Spring, AngularJS, Grails, X/HTML, XML, XForms, CSS, Relational Databases
