...
\begin{multicols}{2}
  ...
  \textbf{Languages}: Go, Rust, Javascript, Java, Haskell, \LaTeX, C, \CC,
...
\item Created and improved various internal tooling for things like: managing
  Kubernetes clusters, deploying applications (usually to Kubernetes), creating
  AWS accounts, maintaining cross-account permissions, generating test data,
  leveraging AWS spot instances, and more.
\end{itemize}
