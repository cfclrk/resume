...
\begin{itemize}
\item I worked mostly on automation for creating and managing Kubernetes
  clusters (and applications running on the clusters)
\item Helped debug and fix application problems on Kubernetes
\item Helped create and implement a company cloud strategy; for example, how to
  create, manage, and secure AWS (and Azure) accounts, and how to audit
  important activity in those accounts.
\end{itemize}

\tag{Python} \tag{Bash} \tag{Kubernetes} \tag{AWS} \tag{Azure} \tag{Terraform}
